                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#order id</th><th>Date</th><th>User Id</th><th>Total</th><th>Status</th><th>Tracking</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($order as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->user->name }}</td><td>{{ $item->total }}</td><td>@switch($item->status)
                                    @case("created") 
